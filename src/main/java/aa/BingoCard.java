...
// Panel 2'deki JTextField'ları doldur
        JTextField[][] panel2Columns = {
        ...
        fillTextFields(panel2Columns);

// Panel 4'deki JTextField'ları doldur
        JTextField[][] panel4Columns = {
        ...
        fillTextFields(panel4Columns);
         
      /*  // Panel 2'deki JTextField'ları doldur
        JTextField[][] panel2Columns = {
            {jTextField1, jTextField7, jTextField10},
            {jTextField2, jTextField8, jTextField17},
            {jTextField5, jTextField11, jTextField9},
            {jTextField3, jTextField12, jTextField15},
            {jTextField4, jTextField13, jTextField18},
            {jTextField6, jTextField14, jTextField16},
            {jTextField19, jTextField20, jTextField21},
            {jTextField22, jTextField23, jTextField24},
            {jTextField25, jTextField26, jTextField27}
        };
        fillTextFields(panel2Columns);

        // Panel 4'deki JTextField'ları doldur
        JTextField[][] panel4Columns = {
            {jTextField28, jTextField34, jTextField37},
            {jTextField29, jTextField35, jTextField44},
            {jTextField32, jTextField38, jTextField36},
            {jTextField30, jTextField39, jTextField42},
            {jTextField31, jTextField40, jTextField45},
            {jTextField33, jTextField41, jTextField43},
            {jTextField46, jTextField47, jTextField48},
            {jTextField49, jTextField50, jTextField51},
            {jTextField52, jTextField53, jTextField54}
        };
        fillTextFields(panel4Columns);
    }
*/   }
    ...
    private void fillAllNumbers(JTextField[] fields, Set<Integer> usedNumbers, int minRange, int maxRange) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            do {
                ...
                randomNumber = generateUniqueRandomNumber(usedNumbers);
            } while (randomNumber < minRange || randomNumber > maxRange); // Check if number is within range

            // JTextField'a rastgele sayıyı yaz
            field.setText(String.valueOf(randomNumber));
    ...
    private void selectRandomFields(JTextField[] fields) {
        // Satırdaki tüm text field'ları listeleyelim
        List<JTextField> textFieldList = Arrays.asList(fields);

        // Rastgele sırayı karıştıralım
        Collections.shuffle(textFieldList);

        // İlk 5 text field'ı seçelim ve geri kalanlarını boş bırakalım
        for (int i = 0; i < fields.length; i++) {
            if (i < 5) {
                fields[i].setEnabled(true); // Eğer belirli bir text field'ı kullanılabilir hale getirmek isterseniz
            } else {
                fields[i].setText(""); // Geri kalan text field'ları boş bırakalım
                fields[i].setEnabled(false); // Eğer belirli bir text field'ı devre dışı bırakmak isterseniz
            }
        }
    }
...
// checkTextFieldColors metodunu çağırırken tüm JTextField'ları tek bir diziye toplamak
        ...
        /*// Start button'a basıldıktan sonra cinkobutton'a basıldığında gerçekleştirilecek işlemler
        // Panel 2 ve Panel 4'teki JTextField'ları kontrol et
        checkTextFieldColors(jTextField1, jTextField2, jTextField3, jTextField4, jTextField5,
                jTextField6, jTextField7, jTextField8, jTextField9, jTextField10,
                jTextField11, jTextField12, jTextField13, jTextField14, jTextField15,
                jTextField16, jTextField17, jTextField18, jTextField19, jTextField20,
                jTextField21, jTextField22, jTextField23, jTextField24, jTextField25,
                ...
                jTextField46, jTextField47, jTextField48, jTextField49, jTextField50,
                jTextField51, jTextField52, jTextField53, jTextField54);*/
// Belirtilen textfield'ların rengini kontrol eden metot
